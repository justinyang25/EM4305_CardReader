...
#define	Carrier_On()	TR1 = 1
#define	Carrier_Off()	{TR1 = 0; T1CLK = 0;}

#define	RF64_Min (150*(FOSC/1000))/12/1000    //100us
#define	RF64_Mid (350*(FOSC/1000))/12/1000    //350us
#define	RF64_Max (600*(FOSC/1000))/12/1000    //650us

#define	RF32_Min (50*(FOSC/1000))/12/1000     //50us
#define	RF32_Mid (160*(FOSC/1000))/12/1000    //200us
#define	RF32_Max (300*(FOSC/1000))/12/1000    //350us¡
